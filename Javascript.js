if (document.getElementById('menue')) {
	document.getElementById('menue').onclick = function() {
		...
		document.all.menue2.style.display = "inline";
		document.all.menue.style.display = "none";
	}
...
if (document.getElementById('menue2')) {
	document.getElementById('menue2').onclick = function() {
		document.all.navigation.style.display = "none";
		document.all.menue.style.display = "inline";
		document.all.menue2.style.display = "none";
